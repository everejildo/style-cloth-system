...
public class tallaProducto extends JDialog {
	...
	public static void main(String[] args) {
		try {
			tallaProducto dialog = new tallaProducto(idioma);
	...
	public tallaProducto(Locale idioma) {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(tallaProducto.class.getResource("/imagenes/v914-ning-21a.png")));
		// Internacionalización
		tallaProducto.idioma = idioma;
		...
		}
		{
			...
			btnNuevo.setIcon(new ImageIcon(tallaProducto.class.getResource("/imagenes/anadir.png")));
		...
		}
		{
			...
			btnGuardar.setIcon(new ImageIcon(tallaProducto.class.getResource("/imagenes/salvar.png")));
		...
		}
		{
			...
			btnActualizar.setIcon(new ImageIcon(tallaProducto.class.getResource("/imagenes/actualizar-flecha.png")));
		...
		}
		{
			...
			btnEliminar.setIcon(new ImageIcon(tallaProducto.class.getResource("/imagenes/borrar (1).png")));
		...
		}
		{
			...
			btnLimpiar.setIcon(new ImageIcon(tallaProducto.class.getResource("/imagenes/escoba.png")));
		...
		}
		{
			...
			btnModificar.setIcon(new ImageIcon(tallaProducto.class.getResource("/imagenes/boligrafo-cuadrado.png")));
		...
		}
		{
			...
			btnAtras.setIcon(new ImageIcon(tallaProducto.class.getResource("/imagenes/angulo-circulo-izquierda.png")));
	...
	public class ManejadorBotones implements ActionListener {
		public void actionPerformed(ActionEvent evento) {
			if (evento.getSource().equals(btnAtras)) {
				// Regresar al menu
				gestionproductos tallaProducto = new gestionproductos(idioma);
