...
public class gestionproveedoresProducto extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					gestionproveedoresProducto frame = new gestionproveedoresProducto(idioma);
	...
	public gestionproveedoresProducto(Locale idioma) {
		// Internacionalización
		gestionproveedoresProducto.idioma = idioma;
		...
		btnAtras.setIcon(new ImageIcon(gestionproveedoresProducto.class.getResource("/imagenes/angulo-circulo-izquierda.png")));
		...
		btnNuevoProducto.setIcon(new ImageIcon(gestionproveedoresProducto.class.getResource("/imagenes/anadir.png")));
		...
		btnGuardarProducto.setIcon(new ImageIcon(gestionproveedoresProducto.class.getResource("/imagenes/salvar.png")));
		...
		btnActualizarProducto
				.setIcon(new ImageIcon(gestionproveedoresProducto.class.getResource("/imagenes/actualizar-flecha.png")));
		...
		btnEliminarProducto.setIcon(new ImageIcon(gestionproveedoresProducto.class.getResource("/imagenes/borrar (1).png")));
		...
		btnLimpiarProducto.setIcon(new ImageIcon(gestionproveedoresProducto.class.getResource("/imagenes/escoba.png")));
		...
		btnModificarProveedor.setIcon(new ImageIcon(gestionproveedoresProducto.class.getResource("/imagenes/boligrafo-cuadrado.png")));
		...
		btnAggEmpresa.setIcon(new ImageIcon(gestionproveedoresProducto.class.getResource("/imagenes/capa-mas.png")));
	...
	public class ManejadorBotones implements ActionListener {
		public void actionPerformed(ActionEvent evento) {
			if (evento.getSource().equals(btnAtras)) {
				gestionproductos gestionproveedoresProducto = new gestionproductos(idioma);
				gestionproveedoresProducto.setVisible(true);
				dispose();
			}
