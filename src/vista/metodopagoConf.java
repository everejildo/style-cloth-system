...
public class metodopagoConf extends JDialog {
	...
	public static void main(String[] args) {
		try {
			metodopagoConf dialog = new metodopagoConf(idioma);
	...
	public metodopagoConf(Locale idioma) {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(metodopagoConf.class.getResource("/imagenes/v914-ning-21a.png")));
		// Internacionalización
		metodopagoConf.idioma = idioma;
		...
		}
		{
			...
			btnNuevo.setIcon(new ImageIcon(metodopagoConf.class.getResource("/imagenes/anadir.png")));
		...
		}
		{
			...
			btnGuardar.setIcon(new ImageIcon(metodopagoConf.class.getResource("/imagenes/salvar.png")));
		...
		}
		{
			...
			btnActualizar.setIcon(new ImageIcon(metodopagoConf.class.getResource("/imagenes/actualizar-flecha.png")));
		...
		}
		{
			...
			btnEliminar.setIcon(new ImageIcon(metodopagoConf.class.getResource("/imagenes/borrar (1).png")));
		...
		}
		{
			...
			btnLimpiar.setIcon(new ImageIcon(metodopagoConf.class.getResource("/imagenes/escoba.png")));
		...
		}
		{
			...
			btnModificar.setIcon(new ImageIcon(metodopagoConf.class.getResource("/imagenes/boligrafo-cuadrado.png")));
		...
		}
		{
			...
			btnAtras.setIcon(new ImageIcon(metodopagoConf.class.getResource("/imagenes/angulo-circulo-izquierda.png")));
	...
	public class ManejadorBotones implements ActionListener {
		public void actionPerformed(ActionEvent evento) {
			if (evento.getSource().equals(btnAtras)) {
				// Regresar al menu
				configuracion metodopagoVentas = new configuracion(idioma);
