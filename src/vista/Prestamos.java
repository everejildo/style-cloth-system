...
import controlador.Controlador_Prestamos;
...
public class Prestamos extends JFrame {
	...
	public Prestamos() {
		...
		buttonGroup_1.add(chckbxGasolina);
		...
		buttonGroup_1.add(chckbxCarnada);
		...
		buttonGroup_1.add(chckbxDinero);
	...
	public class ManejadorBotones implements ActionListener {
		public void actionPerformed(ActionEvent eventoBotones) {
			 ...
			 * PerfilPescador Prestamos = new PerfilPescador(); 
