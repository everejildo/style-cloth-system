...
public class puestoConf extends JDialog {
	...
	public static void main(String[] args) {
		try {
			puestoConf dialog = new puestoConf(idioma);
	...
	public puestoConf(Locale idioma) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(puestoConf.class.getResource("/imagenes/v914-ning-21a.png")));
		// Internacionalización
		puestoConf.idioma = idioma;
		...
		}
		{
			...
			btnNuevoPuesto.setIcon(new ImageIcon(puestoConf.class.getResource("/imagenes/anadir.png")));
		...
		}
		{
			...
			btnGuardarPuesto.setIcon(new ImageIcon(puestoConf.class.getResource("/imagenes/salvar.png")));
		...
		}
		{
			...
			btnActualizarPuesto.setIcon(new ImageIcon(puestoConf.class.getResource("/imagenes/actualizar-flecha.png")));
		...
		}
		{
			...
			btnEliminarPuesto.setIcon(new ImageIcon(puestoConf.class.getResource("/imagenes/borrar (1).png")));
		...
		}
		{
			...
			btnLimpiarPuesto.setIcon(new ImageIcon(puestoConf.class.getResource("/imagenes/escoba.png")));
		...
		}
		{
			...
			btnModificarPuesto.setIcon(new ImageIcon(puestoConf.class.getResource("/imagenes/boligrafo-cuadrado.png")));
		...
		}
		{
			...
			btnAtras.setIcon(new ImageIcon(puestoConf.class.getResource("/imagenes/angulo-circulo-izquierda.png")));
	...
	public class ManejadorBotones implements ActionListener {
		public void actionPerformed(ActionEvent evento) {
			if (evento.getSource().equals(btnAtras)) {
				// Regresar al menu
				configuracion puesto = new configuracion(idioma);
