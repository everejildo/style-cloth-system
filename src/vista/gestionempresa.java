...
public class gestionempresa extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					gestionempresa frame = new gestionempresa(idioma);
	...
	public gestionempresa(Locale idioma) {
		// Internacionalización
		gestionempresa.idioma = idioma;
		...
		btnAtras.setIcon(new ImageIcon(gestionempresa.class.getResource("/imagenes/angulo-circulo-izquierda.png")));
		...
		btnNuevoEmpresa.setIcon(new ImageIcon(gestionempresa.class.getResource("/imagenes/anadir.png")));
		...
		btnGuardarEmpresa.setIcon(new ImageIcon(gestionempresa.class.getResource("/imagenes/salvar.png")));
		...
		btnActualizarEmpresa
				.setIcon(new ImageIcon(gestionempresa.class.getResource("/imagenes/actualizar-flecha.png")));
		...
		btnEliminarEmpresa.setIcon(new ImageIcon(gestionempresa.class.getResource("/imagenes/borrar (1).png")));
		...
		btnLimpiarEmpresa.setIcon(new ImageIcon(gestionempresa.class.getResource("/imagenes/escoba.png")));
		...
		btnModificarEmpresa.setIcon(new ImageIcon(gestionempresa.class.getResource("/imagenes/boligrafo-cuadrado.png")));
	...
	public class ManejadorBotones implements ActionListener {
		public void actionPerformed(ActionEvent evento) {
			if (evento.getSource().equals(btnAtras)) {
				gestionproveedores gestionempresa = new gestionproveedores(idioma);
				gestionempresa.setVisible(true);
				dispose();
			}
