...
public class Controlador_Login2 {
    public static Connection Conexion = null;
    public static String sql;

    // Verificar las credenciales de login
    public boolean verificarLoginDistribuidor(Modelo_Distribuidor usuario) {
        ...
        sql = "SELECT * FROM Distribuidores WHERE Matricula = ? AND Contraseña = ?";
