...
public class tipoConf extends JDialog {
	...
	public static void main(String[] args) {
		try {
			tipoConf dialog = new tipoConf(idioma);
	...
	public tipoConf(Locale idioma) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(tipoConf.class.getResource("/imagenes/v914-ning-21a.png")));
		// Internacionalización
		tipoConf.idioma = idioma;
		...
		}
		{
			...
			btnNuevo.setIcon(new ImageIcon(tipoConf.class.getResource("/imagenes/anadir.png")));
		...
		}
		{
			...
			btnGuardar.setIcon(new ImageIcon(tipoConf.class.getResource("/imagenes/salvar.png")));
		...
		}
		{
			...
			btnActualizar.setIcon(new ImageIcon(tipoConf.class.getResource("/imagenes/actualizar-flecha.png")));
		...
		}
		{
			...
			btnEliminar.setIcon(new ImageIcon(tipoConf.class.getResource("/imagenes/borrar (1).png")));
		...
		}
		{
			...
			btnLimpiar.setIcon(new ImageIcon(tipoConf.class.getResource("/imagenes/escoba.png")));
		...
		}
		{
			...
			btnModificar.setIcon(new ImageIcon(tipoConf.class.getResource("/imagenes/boligrafo-cuadrado.png")));
		...
		}
		{
			...
			btnAtras.setIcon(new ImageIcon(tipoConf.class.getResource("/imagenes/angulo-circulo-izquierda.png")));
	...
	public class ManejadorBotones implements ActionListener {
		public void actionPerformed(ActionEvent evento) {
			if (evento.getSource().equals(btnAtras)) {
				// Regresar al menu
				configuracion tipoProducto = new configuracion(idioma);
