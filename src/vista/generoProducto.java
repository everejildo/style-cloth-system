...
public class generoProducto extends JDialog {
	...
	public static void main(String[] args) {
		try {
			generoProducto dialog = new generoProducto(idioma);
	...
	public generoProducto(Locale idioma) {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(generoProducto.class.getResource("/imagenes/v914-ning-21a.png")));
		// Internacionalización
		generoProducto.idioma = idioma;
		...
		}
		{
			...
			btnNuevo.setIcon(new ImageIcon(generoProducto.class.getResource("/imagenes/anadir.png")));
		...
		}
		{
			...
			btnGuardar.setIcon(new ImageIcon(generoProducto.class.getResource("/imagenes/salvar.png")));
		...
		}
		{
			...
			btnActualizar.setIcon(new ImageIcon(generoProducto.class.getResource("/imagenes/actualizar-flecha.png")));
		...
		}
		{
			...
			btnEliminar.setIcon(new ImageIcon(generoProducto.class.getResource("/imagenes/borrar (1).png")));
		...
		}
		{
			...
			btnLimpiar.setIcon(new ImageIcon(generoProducto.class.getResource("/imagenes/escoba.png")));
		...
		}
		{
			...
			btnModificar.setIcon(new ImageIcon(generoProducto.class.getResource("/imagenes/boligrafo-cuadrado.png")));
		...
		}
		{
			...
			btnAtras.setIcon(new ImageIcon(generoProducto.class.getResource("/imagenes/angulo-circulo-izquierda.png")));
	...
	public class ManejadorBotones implements ActionListener {
		public void actionPerformed(ActionEvent evento) {
			if (evento.getSource().equals(btnAtras)) {
				// Regresar al menu
				gestionproductos generoProducto = new gestionproductos(idioma);
				generoProducto.setVisible(true);
				dispose();
			}
