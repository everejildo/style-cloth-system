...
public class venta extends JFrame {
    ...
    public venta() {
        ...
        lblNewLabel.setBounds(211, 35, 142, 31);
        ...
        btnNewButton_1 = new JButton(et.getString("regresar"));
        btnNewButton_1.setBackground(new Color(64, 159, 255));
        btnNewButton_1.setBounds(541, 20, 103, 46);
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                /*PerfilPescador venta = new PerfilPescador();
